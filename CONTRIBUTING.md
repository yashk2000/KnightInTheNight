...
```
$ git clone https://github.com/yashk2000/KnightInTheNight.git
$ cd KnightInTheNight
$ git remote add upstream https://github.com/yashk2000/KnightInTheNight.git
```
...
- Game: If you're working on implementing a feature in the game, the commit should begin with `game: 'Brief Description'`
